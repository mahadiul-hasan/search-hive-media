...
export function UpdateSearchStatForm({
	...
	const formSchema = z.object({
		searches: z.coerce.number().optional(),
		valid: z.coerce.number().optional(),
		mistake: z.coerce.number().optional(),
		monetized: z.coerce.number().optional(),
		unique_ips: z.coerce.number().optional(),
		visitors: z.coerce.number().optional(),
